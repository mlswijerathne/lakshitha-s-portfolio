...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center relative overflow-hidden bg-white dark:bg-slate-900">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-accent-200/20 dark:bg-accent-500/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent-100/20 dark:bg-accent-500/5 rounded-full blur-3xl"></div>
...
<div className="scroll-hidden" data-scroll="fade-up">
            ...
            <div className="scroll-hidden" data-scroll="fade-up">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 dark:text-white tracking-tight leading-[1.1]">
            ...
            <div className="scroll-hidden" data-scroll="fade-up">
              <h2 className="text-lg sm:text-xl text-gray-500 dark:text-gray-400 font-medium max-w-lg">{personalInfo.title}</h2>
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-2 scroll-hidden" data-scroll="fade-up">
              <button onClick={scrollToContact} className="px-8 py-3.5 bg-accent-600 text-white font-medium rounded-full hover:bg-accent-700 transition-all duration-200 hover:shadow-lg hover:shadow-accent-200 dark:hover:shadow-accent-900/30">
                Let's Talk
              </button>
              <a href="https://drive.google.com/uc?export=download&id=1K975JeLDGraRckma8iH5bu6KBuQd0C_U" target="_blank" rel="noopener noreferrer" className="px-8 py-3.5 border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-medium rounded-full hover:border-accent-300 dark:hover:border-accent-600 hover:text-accent-600 dark:hover:text-accent-400 transition-all duration-200">
                Download CV
              </a>
            </div>
